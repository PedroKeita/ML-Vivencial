"""
Validação do modelo Gaussian Naive Bayes usando amostragem aleatória.
...
def bayes_validator(X, y, rounds=500):
    """
    Executa validação aleatória do modelo Gaussian Naive Bayes.
